				...
				<form action="" method="POST">
					<div class="modal-body">
						<div class="wrap-input101 ">
							<input class="input101" type="text" name="name" placeholder="Nama" required>
						</div>

						<div class="wrap-input101 ">
							<input class="input101" type="email" name="email" placeholder="e-mail" required>
						</div>

						<div class="wrap-input101 ">
							<input class="input101" type="text" name="telp" placeholder="telp" required>
						</div>

						<div class="wrap-input101 ">
							<input class="input101" type="password" name="password2" placeholder="password" required>
						</div>

						<div class="wrap-input101 ">
							<input class="input101" type="password" name="password3" placeholder="Konfirmasi password" required>
						</div>

						<div class="wrap-input101 ">
							<input class="input101" type="text" name="alamat" placeholder="Alamat" required>
						</div>

						<div class="wrap-input101 ">
							<input class="input101" type="text" name="ttl" placeholder="ttl" required>
						</div>
